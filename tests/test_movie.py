...
def movie_dao():
    ...
    movie_1 = Movie(id=1, title='title_1', description='description_1', trailer='trailer_1', year=2020, rating=11.1,
                    genre_id=1, director_id=1)
    movie_2 = Movie(id=2, title='title_2', description='description_2', trailer='trailer_2', year=2032, rating=12,
